...
function HomeProfile({ myProfile }) {
  ...
  return (
    <>
      ...
      <Card className="mt-2 posizione">
        <ListGroup variant="flush">
          <ListGroup.Item>
            <p className="proBlue" style={{ cursor: "pointer" }}>
              Group
            </p>
            <div className="d-flex align-item-center justify-content-between tratto">
              <div className="proBlue" style={{ cursor: "pointer" }}>
                Events
              </div>
              <div title="Create an event" className="homeModalH" style={{ cursor: "pointer" }}>
                <AiOutlinePlus />
              </div>
            </div>
            <p className="proBlue" style={{ cursor: "pointer" }}>
