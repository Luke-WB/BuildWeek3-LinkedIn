                  ...
                  <Modal.Body style={{ overflowY: "scroll" }}>
                    <Form className="text-secondary">
                      ...
                      <p style={{ fontSize: "14px", color: "#535454" }}>
                        <BsFillInfoSquareFill /> Può essere aggiunta solo usando
                        la nostra app per dispositivi mobili
                      </p>
                      <Form.Group
                        className="mb-3 text-secondary"
                        style={{ fontSize: "14px" }}
                      ...
                      <p style={{ fontSize: "14px" }}>
                        {" "}
                        Aggiungi o modifica il tuo profilo URL, indirizzo email
                        e altro
                      </p>
                      ...
                      <h5> Sito Web</h5>
                      <Form.Text className="text-muted">
                        Aggiungi un link che apparirà nella parte superiore del
                        tuo profilo
                      </Form.Text>
                      <Form.Group
                        className="mb-3 text-secondary"
